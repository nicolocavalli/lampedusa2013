...
outreg2 using Figure5Controls.doc, append dec(2) bdec(3) alpha(0.001, 0.01, 0.05)
}
...
* Replicate without controls
ebalance treatment_lampedusa agea_mi i.male_mi i.eisced_mi i.mainjob_num_mi i.immigrant_num_mi lrscale_mi i.region_num attempted 

foreach var of varlist policy imsmetn_mi imdfetn_mi impcntr_mi attitudes imbgeco_mi imueclt_mi imwbcnt_mi {
*gen t`var'=treatment_lampedusa
reg `var' i.treatment_lampedusa##c.support_lampedusa  [w=pspwght*_webal]
outreg2 using Figure7_1stPoly_nc.doc, append  dec(3) bdec(3) alpha(0.001, 0.01, 0.05)

}

foreach var of varlist policy imsmetn_mi imdfetn_mi impcntr_mi attitudes imbgeco_mi imueclt_mi imwbcnt_mi {
*gen t`var'=treatment_lampedusa
reg `var' i.treatment_lampedusa##c.support_lampedusa##c.support_lampedusa [w=pspwght*_webal]
outreg2 using Figure7_2ndPoly_nc.doc, append  dec(3) bdec(3) alpha(0.001, 0.01, 0.05)
}

coefplot reg8nc* || reg10nc*, keep(tpolicy timsmetn_mi timdfetn_mi timpcntr_mi tattitudes timbgeco_mi timueclt_mi timwbcnt_mi ) mcolor(black) lcolor(black) horizontal  xline(0) legend(off)  symbol(O)
...
qui reg `var' treatment_lampedusa if support_lampedusa>=-60  & support_lampedusa<=60 [w=pspwght*_webal]
outreg2 using Figure7_60nc.doc, append  dec(3) bdec(3) alpha(0.001, 0.01, 0.05)
qui reg `var' treatment_lampedusa  agea_mi i.male_mi i.eisced_mi i.mainjob_num_mi i.immigrant_num_mi lrscale_mi i.region_num if support_lampedusa>=-60  & support_lampedusa<=60 [w=pspwght*_webal]
...
qui reg `var' treatment_lampedusa if support_lampedusa>=-45  & support_lampedusa<=45 [w=pspwght*_webal]
outreg2 using Figure7_45nc.doc, append  dec(3) bdec(3) alpha(0.001, 0.01, 0.05)
qui reg `var' treatment_lampedusa  agea_mi i.male_mi i.eisced_mi i.mainjob_num_mi i.immigrant_num_mi lrscale_mi i.region_num if support_lampedusa>=-45  & support_lampedusa<=45 [w=pspwght*_webal]
...
qui reg `var' treatment_lampedusa if support_lampedusa>=-30  & support_lampedusa<=30 [w=pspwght*_webal]
outreg2 using Figure7_30nc.doc,  append  dec(3) bdec(3) alpha(0.001, 0.01, 0.05)
qui reg `var' treatment_lampedusa  agea_mi i.male_mi i.eisced_mi i.mainjob_num_mi i.immigrant_num_mi lrscale_mi i.region_num if support_lampedusa>=-30  & support_lampedusa<=30 [w=pspwght*_webal]
...
qui reg `var' treatment_lampedusa if support_lampedusa>=-15  & support_lampedusa<=15 [w=pspwght*_webal]
outreg2 using Figure7_15nc.doc,  append  dec(3) bdec(3) alpha(0.001, 0.01, 0.05)
qui reg `var' treatment_lampedusa  agea_mi i.male_mi i.eisced_mi i.mainjob_num_mi i.immigrant_num_mi lrscale_mi i.region_num if support_lampedusa>=-15  & support_lampedusa<=15 [w=pspwght*_webal]
outreg2 using Figure7_15.doc,  append  dec(3) bdec(3) alpha(0.001, 0.01, 0.05)
	}

	
* Replicating figures without controls
...
*eststo reg3`i'_`var'
reg `var' t`var'  if support_lampedusa>=-`i'   & support_lampedusa<=`i' [w=pspwght*_webal]
eststo reg4nc`i'_`var'
	}
}
coefplot  reg4nc60_* || reg4nc45_* || reg4nc30_* || reg4nc15_* , keep(tpolicy timsmetn_mi timdfetn_mi timpcntr_mi tattitudes timbgeco_mi timueclt_mi timwbcnt_mi ) mcolor(black) lcolor(black) horizontal  xline(0) legend(off) symbol(0)
...
reg attitudes i.treatment_lampedusa##(c.agea_mi i.male_mi i.eisced_mi i.mainjob_num_mi i.immigrant_num_mi c.lrscale_mi  i.region_num) [w=pspwght*_webal]
...
gen lrscale_rescaled=1 if lrscale_mi<5
replace lrscale_rescaled=2 if lrscale_mi==5
replace lrscale_rescaled=3 if lrscale_mi>5 & lrscale_mi!=.

label define lrscale_rescaled 1 "Left wing" 2 "Center" 3 "Right wing"
label variable treatment_lampedusa   "Treatment status" 


reg policy i.treatment_lampedusa##i.lrscale_rescaled agea_mi i.male_mi i.eisced_mi i.mainjob_num_mi i.immigrant_num_mi lrscale_mi i.region_num [w=pspwght*_webal]
margins treatment_lampedusa#lrscale_rescaled
marginsplot

reg attitudes i.treatment_lampedusa##i.lrscale_rescaled agea_mi i.male_mi i.eisced_mi i.mainjob_num_mi i.immigrant_num_mi lrscale_mi i.region_num [w=pspwght*_webal]
margins treatment_lampedusa#lrscale_rescaled
marginsplot

** Appendix B **

* Margins plot for each item *
reg imsmetn_mi i.treatment_lampedusa##i.lrscale_rescaled agea_mi i.male_mi i.eisced_mi i.mainjob_num_mi i.immigrant_num_mi lrscale_mi i.region_num [w=pspwght*_webal]
margins treatment_lampedusa#lrscale_rescaled
marginsplot

reg imdfetn_mi i.treatment_lampedusa##i.lrscale_rescaled agea_mi i.male_mi i.eisced_mi i.mainjob_num_mi i.immigrant_num_mi lrscale_mi i.region_num [w=pspwght*_webal]
margins treatment_lampedusa#lrscale_rescaled
marginsplot

reg impcntr_mi i.treatment_lampedusa##i.lrscale_rescaled agea_mi i.male_mi i.eisced_mi i.mainjob_num_mi i.immigrant_num_mi lrscale_mi i.region_num [w=pspwght*_webal]
margins treatment_lampedusa#lrscale_rescaled
marginsplot

reg imbgeco_mi i.treatment_lampedusa##i.lrscale_rescaled agea_mi i.male_mi i.eisced_mi i.mainjob_num_mi i.immigrant_num_mi lrscale_mi i.region_num [w=pspwght*_webal]
margins treatment_lampedusa#lrscale_rescaled
marginsplot

reg imueclt_mi i.treatment_lampedusa##i.lrscale_rescaled agea_mi i.male_mi i.eisced_mi i.mainjob_num_mi i.immigrant_num_mi lrscale_mi i.region_num [w=pspwght*_webal]
margins treatment_lampedusa#lrscale_rescaled
marginsplot

reg imwbcnt_mi i.treatment_lampedusa##i.lrscale_rescaled agea_mi i.male_mi i.eisced_mi i.mainjob_num_mi i.immigrant_num_mi lrscale_mi i.region_num [w=pspwght*_webal]
margins treatment_lampedusa#lrscale_rescaled
marginsplot
